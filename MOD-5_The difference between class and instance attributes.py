...
'''
Этот код определяет класс Building и создает 40 экземпляров этого класса.
Класс Building имеет атрибут total, который инициализируется значением 0 в конструкторе класса __init__(). 
